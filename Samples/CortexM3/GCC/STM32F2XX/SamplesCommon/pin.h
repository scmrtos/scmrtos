...
struct Pin
{
	...
	enum
	{
		...
		IDR_BB_ADDR      = pPERIPH_BB_BASE + (GPIOx_BASE + offsetof(GPIOxTypeDef, IDR) - pPERIPH_BASE) * 32 + pin * 4,
		ODR_BB_ADDR      = pPERIPH_BB_BASE + (GPIOx_BASE + offsetof(GPIOxTypeDef, ODR) - pPERIPH_BASE) * 32 + pin * 4,

		MODER_BB_ADDR    = pPERIPH_BB_BASE + (GPIOx_BASE + offsetof(GPIOxTypeDef, MODER) - pPERIPH_BASE) * 32 + shift_x2 * 4,
		OTYPER_BB_ADDR   = pPERIPH_BB_BASE + (GPIOx_BASE + offsetof(GPIOxTypeDef, OTYPER) - pPERIPH_BASE) * 32 + pin * 4,
		OSPEEDR_BB_ADDR  = pPERIPH_BB_BASE + (GPIOx_BASE + offsetof(GPIOxTypeDef, OSPEEDR) - pPERIPH_BASE) * 32 + shift_x2 * 4,
		PUPDR_BB_ADDR    = pPERIPH_BB_BASE + (GPIOx_BASE + offsetof(GPIOxTypeDef, PUPDR) - pPERIPH_BASE) * 32 + shift_x2 * 4,

		GPIO_BB_ADDR     = pPERIPH_BB_BASE + (GPIOx_BASE + offsetof(GPIOxTypeDef, MODER) - pPERIPH_BASE) * 32 + shift_x2 * 4
	};
