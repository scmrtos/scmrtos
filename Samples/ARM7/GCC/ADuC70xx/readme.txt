ARM7/GCC scmRTOS port, ADuC70xx samples -- short description.
...
scmRTOS        - scmRTOS Common, Extensions and ARM/GCC port files.
...
ADuC70xx/GCC Release description (in English)
    http://scmrtos.sourceforge.net/ADuC70xx_GCC_Release
