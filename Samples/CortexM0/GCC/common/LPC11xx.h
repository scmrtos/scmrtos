...
/* SYSMEMREMAP: System memory remap (R/W) */
enum
{
    LPC_MAP_BOOT = 0,
    LPC_MAP_RAM,
...
/*  PRESETCTRL: Peripheral reset control (R/W) */
enum
{
    LPC_SSP0_RST_N = 0,
    LPC_I2C_RST_N,
...
/* SYSPLLCTRL: System PLL control (R/W) */
enum
{
    LPC_MSEL = 0,
    LPC_PSEL = 5,
...
/* SYSPLLSTAT: System PLL status (R/ ) */
enum
{
    LPC_PLL_LOCK = 0,
};

/*SYSOSCCTRL: System oscillator control (R/W) */
enum
{
    LPC_OSC_BYPASS = 0,
    LPC_OSC_FREQRANGE,
...
/*WDTOSCCTRL: Watchdog oscillator control (R/W) */
enum
{
    LPC_WDT_DIVSEL = 0,
    LPC_WDT_FREQSEL = 5,
...
/*IRCCTRL: IRC control (R/W) */
enum
{
    LPC_IRC_TRIM = 0,
};

/*SYSRESSTAT: System reset status Register (R/ ) */
enum
{
    LPC_RESET_POR = 0,
    LPC_RESET_EXTRST,
...
/*SYSPLLCLKSEL: System PLL clock source select (R/W) */
enum
{
    LPC_PLLCLK_SEL = 0,
        LPC_PLLCLK_IRC = 0,
...
/*SYSPLLCLKUEN: System PLL clock source update enable (R/W) */
/*MAINCLKUEN: Main clock source update enable (R/W) */
/*WDTCLKUEN: WDT clock source update enable (R/W) */
/*CLKOUTUEN: CLKOUT clock source update enable (R/W) */
enum
{
    LPC_CLK_ENA = 0,
};

/*MAINCLKSEL: Main clock source select (R/W) */
enum
{
    LPC_MAINCLK_SEL = 0,
        LPC_MAINCLK_IRC = 0,
...
/*SYSAHBCLKDIV: System AHB clock divider (R/W) */
/*SSP0CLKDIV: SSP0 clock divider (R/W) */
/*UARTCLKDIV: UART clock divider (R/W) */
/*SSP1CLKDIV: SSP1 clock divider (R/W) */
/*SYSTICKCLKDIV: SYSTICK clock divider (R/W) */
/*WDTCLKDIV: WDT clock divider (R/W) */
/*CLKOUTDIV: CLKOUT clock divider (R/W) */
enum
{
    LPC_CLK_DIV = 0,
};

/*SYSAHBCLKCTRL: System AHB clock control (R/W) */
enum
{
    LPC_AHBCLK_SYS = 0,
    LPC_AHBCLK_ROM,
...
/*WDTCLKSEL: WDT clock source select (R/W) */
enum
{
    LPC_WDTCLK_SEL = 0,
        LPC_WDTCLK_IRC = 0,
...
/*CLKOUTCLKSEL: CLKOUT clock source select (R/W) */
enum
{
    LPC_CLKOUT_SEL = 0,
        LPC_CLKOUT_IRC = 0,
...
/*PIOPORCAP0: POR captured PIO status 0 (R/ ) */
/*PIOPORCAP1: POR captured PIO status 1 (R/ ) */

/*BODCTRL;       : BOD control (R/W) */
enum
{
    LPC_BODRSTLEV = 0,
    LPC_BODINTVAL = 2,
...
/*SYSTCKCAL;     : System tick counter calibration (R/W) */
/*STARTAPRP0;    : Start logic edge control Register 0 (R/W) */
/*STARTERP0;     : Start logic signal enable Register 0 (R/W) */
/*STARTRSRP0CLR; : Start logic reset Register 0  ( /W) */
/*STARTSRP0;     : Start logic status Register 0 (R/W) */

/*PDSLEEPCFG;    : Power-down states in Deep-sleep mode (R/W) */
/*PDAWAKECFG;    : Power-down states after wake-up (R/W) */
/*PDRUNCFG;      : Power-down configuration Register (R/W) */
enum
{
    LPC_IRCOUT_PD = 0,
    LPC_IRC_PD,
...
/* TCR : Timer Control Register (R/W) */
enum
{
    LPC_TMR_CE = 0,
    LPC_TMR_CRST,
...
/* MCR : Match Control Register (R/W) */
enum
{
    LPC_TMR_MR0I = 0,
    LPC_TMR_MR0R,
...
/* MOD; Watchdog mode register (R/W) */
enum
{
    LPC_WDEN = 0,
    LPC_WDRESET,
